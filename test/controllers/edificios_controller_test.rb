...
class EdificiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edificio" do
    assert_difference('Edificio.count') do
      post edificios_url, params: { edificio: { ciudad: @edificio.ciudad, direccion: @edificio.direccion, nombre: @edificio.nombre } }
    end
  ...
  test "should update edificio" do
    patch edificio_url(@edificio), params: { edificio: { ciudad: @edificio.ciudad, direccion: @edificio.direccion, nombre: @edificio.nombre } }
